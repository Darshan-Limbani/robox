        ...
        <div className="space-y-8">
          <section className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Welcome to Robox! By using our platform, you agree to comply with and be bound by the following terms and
              conditions.
            </p>
          </section>
          ...
          <section className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="text-gray-600 leading-relaxed">
              You agree to use our platform responsibly and not to engage in any fraudulent activities. Any misuse of
          ...
          <section className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="text-gray-600 leading-relaxed">
              All content on this platform, including quizzes and graphics, is owned by Math Quiz. Unauthorized use is
              strictly prohibited.
            </div>
          </section>
          ...
          <section className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="text-gray-600 leading-relaxed">
              We may update these terms from time to time. It is your responsibility to review the terms regularly.
